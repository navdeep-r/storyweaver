    ...
    >
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        {!book.coverUrl && (
          <div className="w-full h-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center">
            <svg className="w-12 h-12 text-slate-300 dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="p-4">
        ...
        <div className="mt-2 flex flex-wrap gap-1">
          ...
          {book.publisher && (
            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-100">
              {book.publisher}
            </span>
          )}
        </div>
